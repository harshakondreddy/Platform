...
public class PlanSpecPRBranch {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        File file = new File(PlanSpecPRBranch.class.getClassLoader().getResource(fileName).getFile());
        ...
        for(Map<String, Object> item: data) {
            ...
            Plan plan = new PlanSpecPRBranch().createPlan(compName, planKey, bbProjectKey, gitSshUrl, sccConfigProject,manifestBBProjectName,manifestRepoName,manifestRepoUrl );
            bambooServer.publish(plan);
            PlanPermissions planPermission = new PlanSpecPRBranch().createPlanPermission(plan.getIdentifier());
    ...
    Plan createPlan(String compName, String planKey, String bbProjectKey, String gitSshUrl, String sccConfigProject ,
        ...
        return new Plan(
                ...
                .planBranchManagement(new PlanBranchManagement()
                        .createForVcsBranchMatching("(?=(j8pr\\/)).*$")
